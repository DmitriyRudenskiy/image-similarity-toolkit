...
- **База данных эмбеддингов**: Хранение и индексация изображений в SQLite
- **Поиск похожих изображений**: Быстрый поиск по базе данных
...
│       ├── database.py     # База данных эмбеддингов
...
- [ ] Поддержка дополнительных моделей (ViT, DINO)
- [ ] Batch-обработка с параллелизацией
